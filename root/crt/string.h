...
// Standard three-way lexical string comparison.
int strcmp(char* str1, char* str2);

// Standard three-way lexical comparison limited to n bytes.
int strncmp(char* str1, char* str2, unsigned n);

// Returns a pointer to the first matching character in str, or NULL.
char* strchr(char* str, int c);

// Returns a pointer to the last matching character in str, or NULL.
